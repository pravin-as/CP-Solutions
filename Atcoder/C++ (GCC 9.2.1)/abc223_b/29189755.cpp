  ...
  //  cin >> TC;
    ...
    while(TC--){
        ...
        for(ll i = 0; i < n; i++){
            ...
            if(lexicographical_compare(str.begin(),str.end(),mx.begin(),mx.end())){
                mx = str;
            }
            if(!lexicographical_compare(str.begin(),str.end(),mn.begin(),mn.end())){
                mn = str;
            }



            debug(str)debug(mx)debug(mn)
        }

    ...
    while(TC--){
            ...
            while(q--){
                ...
                if(type == 1){
                    ...
                    if(str[l] == ')')swap(l,r);
                    seg.update(0,l,n-1,-2,0,n-1);
                    seg.update(0,r,n-1,2,0,n-1);
                    swap(str[l],str[r]);
                }else{
                    ll a = (l > 0 ? seg.query(0,l-1,l-1,0,n-1).mn:0LL);
                    ll b = seg.query(0,r,r,0,n-1).mn;
                    ll c = seg.query(0,l,r,0,n-1).mn;
                    if(a == b && c >= a){
                        cout << "Yes" << "\n";
                    }else{
                        cout << "No" << "\n";

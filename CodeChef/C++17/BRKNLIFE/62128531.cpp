...
void solve(){
    ...
    vector<char> character = {'a', 'b', 'c', 'd', 'e'};
 
    while(TC--){


            ll n, m, itr1 = 0, itr2 = 0, itr3 = 0, itr4 = 0; cin >> n >> m;
            ...
            while(itr1 < n && itr2 < m){
                if(str1[itr1] == str2[itr2]){
                    ...
                    for(ll j = 0; j < 5; j++){
                        if(character[j] != str2[itr2]){
                            str1[itr1] = character[j];
                            break;
                        }
                    }
                }
            ...
            while(true){
                if(str1[itr3] == str2[itr4]){
                    itr4++;
                    itr3++;
                }else{
                    itr3++;
                }
                if(itr3 >= n || itr4 >= m)break;

	...
	public static void main(String[] args) {
		...
		try {
			...
			while (t > 0) {
				...
				long x1 = fr.nextLong(), x2 = fr.nextLong(), x3 = fr.nextLong(), r = fr.nextLong(), ans = 0;
				...
				if (x2 >= x3 + r && x1 >= x3 + r || x2 <= x3 - r && x1 <= x3 - r) {
					ans = Math.abs(x2 - x1);
				} else if (x1 >= x3 + r && x2 >= x3 - r) {
					ans = Math.abs(x1 - (x3 + r));
				} else if (x1 <= x3 + r && x2 >= x3 - r) {
					ans = Math.abs(0);
				} else if (x1 >= x3 - r && x2 <= x3 - r && x1 <= x3 + r) {
					ans = Math.abs(x2 - (x3 - r));
				} else if (x1 >= x3 + r && x2 <= x3 - r) {
					ans = Math.abs(x1 - (x3 + r)) + Math.abs(x2 - (x3 - r));
				}

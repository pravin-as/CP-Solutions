...
//		try {
		...
		while (t > 0) {
			...
			for (int i = 0; i < n; i++) {
				if (str.charAt(i) == 's' || str.charAt(i) == 'h' || str.charAt(i) == 'e' || str.charAt(i) == 'r'
						|| str.charAt(i) == 'l' || str.charAt(i) == 'o' || str.charAt(i) == 'c'
						|| str.charAt(i) == 'k') {
			...
			if (!(x.containsKey('s') && x.containsKey('h') && x.containsKey('e') && x.containsKey('r')
					&& x.containsKey('l') && x.containsKey('o') && x.containsKey('c') && x.containsKey('k'))) {
				min = 0;
			}

			for (HashMap.Entry<Character, Integer> entry : x.entrySet()) {

...
class Dobby {
	...
	static int n = (int) 1e7 + 9;

	static ArrayList<Long> ans1 = new ArrayList<>();
	static ArrayList<Long> ans2 = new ArrayList<>();
	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int i = 5; i < (int) 1e7 + 5; i++) {

				count += A[i] ? 1 : 0;
				count -= i % 2 == 0 ? A[i / 2] ? 1 : 0 : 0;
				x.add(count);

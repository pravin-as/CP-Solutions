...
//		try {
		...
		while (t > 0) {
			...
			if (flag) {
				...
				ArrayList<Integer> char_2 = new ArrayList<>();
				ArrayList<Integer> char_3 = new ArrayList<>();
				ArrayList<Integer> char_5 = new ArrayList<>();
				ArrayList<Integer> char_7 = new ArrayList<>();
				...
				if (char_2.size() > 1) {
					pt.println(2);
					pt.println(2 + "" + 2);
				} else if (char_3.size() > 1) {
					pt.println(2);
					pt.println(3 + "" + 3);
				} else if (char_5.size() > 1) {
					pt.println(2);
					pt.println(5 + "" + 5);
				} else if (char_7.size() > 1) {
					pt.println(2);
					pt.println(7 + "" + 7);
				} else {

					if (str.length() == 2) {
						pt.println(str.length());
						pt.println(str);
					} else if (str.length() == 3) {

						boolean five = false, two = false;

						if (str.contains("5")) {

							if (str.charAt(1) == '5' || str.charAt(2) == '5') {

								pt.println(2);
								pt.println(str.charAt(0) + "" + 5);
								five = true;
						...
						if (str.contains("2") && five == false) {

							if (str.charAt(1) == '2' || str.charAt(2) == '2') {

								pt.println(2);
								pt.println(str.charAt(0) + "" + 2);
								two = true;
						...
						if (five == false && two == false) {
							if (str.equals("237") || str.equals("273")) {
								pt.println(2);
								pt.println("27");
							} else if (str.equals("537") || str.equals("573")) {
								pt.println(2);
								pt.println("57");
							}
						}
						...
						if (str.contains("5")) {
							...
							if (str.charAt(1) == '5' || str.charAt(2) == '5' || str.charAt(3) == '5') {
						...
						if (str.contains("2") && five == false) {
							...
							if (str.charAt(1) == '2' || str.charAt(2) == '2' || str.charAt(3) == '2') {

	...
	public static void main(String[] args) {
		...
		try {
			...
			while (t > 0) {
				...
				int n = fr.nextInt(), k1 = fr.nextInt(), k2 = fr.nextInt(), max_1 = 0, max_2 = 0;

				for (int i = 0; i < k1; i++) {
					max_1 = Math.max(max_1, fr.nextInt());
				}
				for (int i = 0; i < k2; i++) {
					max_2 = Math.max(max_2, fr.nextInt());
				}

				pt.println(max_1 > max_2 ? "YES" : "NO");

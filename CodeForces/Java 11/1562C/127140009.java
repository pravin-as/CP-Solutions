	...
	public static void main(String[] args) {
		...
		try {
			...
			while (t > 0) {
				...
				if (first_zero + 1 <= n / 2 + n % 2 && last_zero != -1) {
					pt.println((first_zero + 1) + " " + n + " " + (first_zero + 2) + " " + n);
				} else if (last_zero != -1) {
					pt.println(1 + " " + (last_zero + 1) + " " + 1 + " " + (last_zero));
				} else {
					pt.println(1 + " " + (n - 1) + " " + 2 + " " + n);
				}

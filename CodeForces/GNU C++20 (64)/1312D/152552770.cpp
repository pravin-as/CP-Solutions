...
void solve(){
    ...
    InverseofNumber(MOD1);
    InverseofFactorial(MOD1);
    factorial(MOD1);
    ...
    while(TC--){
            ...
            ll ans = Binomial(m, n - 1, MOD1);
            ans = mod_mul(ans, n - 2, MOD1);
            if(n >= 3){
                ans = mod_mul(ans, power(2LL, n - 3), MOD1);
            }else{
                ans = mod_div(ans, 2LL, MOD1);
            }

...
void solve(){
    ...
    while(TC--){
            ...
            while(!q.empty()){
                ...
                string temp = tp, temp2 = tp + "0", temp3 = tp + "1";
                reverse(all(temp2)); reverse(all(temp3));
                

                temp2.erase(0, temp2.find_first_not_of('0'));
                temp3.erase(0, temp3.find_first_not_of('0'));


                if(sz(temp2) < 100 && s.find(temp2) == s.end())q.push(temp2);
                if(sz(temp3) < 100 && s.find(temp3) == s.end())q.push(temp3);

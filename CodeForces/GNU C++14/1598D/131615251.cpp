...
ll RightAngled(vector<vector<ll>>& a, ll n)
{
 
    
    unordered_map<ll, ll, custom_hash> xpoints;
    unordered_map<ll, ll, custom_hash> ypoints;
...
void solve(){
    ...
    while(t--){ 
        ...
        cout <<( ((n * (n - 1LL) * (n - 2LL)) / 6LL) - RightAngled(A, n) )<< "\n";

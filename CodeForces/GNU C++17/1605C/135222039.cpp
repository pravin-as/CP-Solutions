...
void solve(){
    ...
    string str; cin >> str;
        ...
        if(str.find("aa") != string::npos){
            ans = 2;
        }else if(str.find("aba") != string::npos){
            ans = 3;
        }else if(str.find("aca") != string::npos){
            ans = 3;
        }else if(str.find("abca") != string::npos){
            ans = 4;
        }else if(str.find("acba") != string::npos){
            ans = 4;
        }else if(str.find("abbacca") != string::npos){
            ans = 7;
        }else if(str.find("accabba") != string::npos){
            ans = 7;
        }

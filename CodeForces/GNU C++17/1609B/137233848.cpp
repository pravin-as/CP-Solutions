...
void solve(){
    ...
    while(t--){
            ...
            while(q--){
                ...
                if(x == 'a'){
                    if((!(str[pos] == 'a')) && pos < n - 2 ){
                        if(str[pos+1] == 'b' && str[pos+2] == 'c'){
                            cnt++;
                        }
                    }
                }else if(x == 'b'){
                    if((!(str[pos] == 'b')) && pos < n - 1 && pos > 0 ){
                        if(str[pos-1] == 'a' && str[pos+1] == 'c'){
                            cnt++;
                        }
                    }
                }else if(x == 'c'){
                    if((!(str[pos] == 'c')) &&  pos > 1 ){
                        if(str[pos-2] == 'a' && str[pos-1] == 'b'){
                            cnt++;
                        }
                    }
                }

                if(pos < n - 2 && str[pos] == 'a' && str[pos+1] == 'b' && str[pos+2] == 'c'){
                    if(!(str[pos] == x)){
                        cnt--;
                    }
                }
                if(pos > 0 && pos < n - 1 && str[pos-1] == 'a' && str[pos] == 'b' && str[pos+1] == 'c'){
                    if(!(str[pos] == x)){
                        cnt--;
                    }
                }
                if(pos > 1 && str[pos-2] == 'a' && str[pos-1] == 'b' && str[pos] == 'c'){
                    if(!(str[pos] == x)){
                        cnt--;
                    }
                }

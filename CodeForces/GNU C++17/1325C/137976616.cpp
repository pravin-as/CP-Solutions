...
void solve(){
    ...
    while(t--){
        ...
        ll n, mx = 0, ind = 1, cnt = 0; cin >> n;


        adj.clear();adj.resize(n+2);vis.clear();vis.resize(n+2);ans.clear();ans.resize(n+2);
        ...
        debug(ind)debug(adj[ind])debug(adj)
